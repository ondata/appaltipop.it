            ...
            <main>
                        ...
                        <Grid container spacing={4}>
                            <Grid item xs={12} sm={6}>
                                <Typography component="div" variant="body2">
                                    <ReactMarkdown
                                        source={
                                            contents.interoperability.content
                                        }
                                    />
                                </Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <img
                                    src={t("home:interoperability.image")}
                                    alt="OCDS"
                                    title="OCDS"
                                    style={{ width: "100%" }}
                                />
                ...
                <Box component="section" className="band band-b band-home">
                    <Container maxWidth="md">
                        ...
                        >
                            <ReactMarkdown
                                source={contents.partnership.content}
                                linkTarget="_blank"
                            />
                        </Typography>
    ...
    return {
        props: {
            ...
            contents: {
                ...
                interoperability: await getStaticPage(
                    namespaces.home.interoperability
                ),
