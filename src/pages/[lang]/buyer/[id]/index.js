                ...
                <Container component="main" maxWidth="md">
                    ...
                    <Box mb={8}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={4}>
                                <KeyValue title={t("buyer:cf")} label={buyer["ID"]} />
                            </Grid>
                    ...
                    <Box mb={8}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <BarChart title={t("buyer:bar.1.title")} description={t("buyer:bar.1.description")} />
                            </Grid>

                            <Grid item xs={12} sm={6}>
                                <BarChart title={t("buyer:bar.2.title")} description={t("buyer:bar.2.description")} />
                            </Grid>
                    ...
                    <Box mb={8}>
                        <BarChart title={t("buyer:bar.3.title")} description={t("buyer:bar.3.description")} />
                    </Box>
                    ...
                    <Box mb={8}>
                        <Typography variant="h2">{t("common:suppliers")}</Typography>
                        <Typography>...</Typography>
                    </Box>
